...
BASE_DIR="/usr/local/vufind2"
SOLR_DIR="${BASE_DIR}/solr"
# dir to get MARC records
INPUT_DIR="/usr/local/vufind2/clouds/in"
# tmp dir to process MARC records
TMP_DIR="/usr/local/vufind2/clouds/tmp_files"
WORKFILE="/tmp/solr_indexing.working"
DELETEFILE="/tmp/delete_ids"
# dir to archive records
ARCHIVE_DIR="/usr/local/vufind2/clouds/archive"
ARCHIVE_LOG_DIR="/usr/local/vufind2/clouds/logs"
