...
class Database extends AbstractBase
{
    ...
    public function create($request)
    {
        ...
        $params = [
            ...
            'password' => '', 'password2' => '', 'email' => '', 'home_library' => '', 'cat_username' => ''  // mylibcloud 
        ];
        ...
        if (trim($params['home_library']) == '') {
             throw new AuthException('Home Library cannot be blank'); // mylibcloud
        }
        if (trim($params['cat_username']) == '') {
             throw new AuthException('Patron Barcode should not be blank'); // mylibcloud
         }
         // mylibcloud need home_library and cat_username which is the barcode
        ...
        $user->home_library = $params['home_library'];
        $user->cat_username = $params['cat_username'];
